...
namespace ProfileComparisonMethod
{
    ...
    {
        public static double DistanceCondition(IEnumerable<string> list1, IEnumerable<string> list2, double weight)
        {
            ...
            {
                Program.LogAspectDifference(weight, "Condition");
                Program.PercentageAspectDifference(100);
                return weight;
            }

            List<string> SortedList1 = list1.OrderBy(c => c).ToList();
            List<string> SortedList2 = list2.OrderBy(c => c).ToList();
            ...
            Program.LogAspectDifference(x, "Condition");
